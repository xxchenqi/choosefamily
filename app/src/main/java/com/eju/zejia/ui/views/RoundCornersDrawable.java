...
/**
 * Created by Sidney on 2016/8/11.
 */
public class RoundCornersDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        float horizontalScale = mRect.width() / mBitmapWidth;
        float verticalScale = mRect.height() / mBitmapHeight;

        mMatrix.setScale(horizontalScale, verticalScale);
